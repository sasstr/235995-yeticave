        ...
        <tr class="rates__item <?= isset($lot_data['item_class_value']) ? $lot_data['item_class_value'] : '' ?>">
          <td class="rates__info">
            ...
            <h3 class="rates__title">
                <a href="lot.php?id=<?= intval($lot['id']) ?> ">
                    <?= htmlspecialchars($lot['lots_title']) ?>
                </a>
            </h3>
          ...
          <td class="rates__timer <?= isset($lot_data['timer_class_value']) ? $lot_data['timer_class_value'] : '' ?>">
            <div class="timer <?= isset($lot_data['timer_class_value']) ? $lot_data['timer_class_value'] : '' ?>"><?= isset($lot_data['rate_msg']) ? $lot_data['rate_msg'] : ''; ?></div>
          </td>
          <td class="rates__price">
            <?= isset($lot['rate_amount']) ? format_price($lot['rate_amount']) : format_price($lot['starting_price']) ?>
          </td>
