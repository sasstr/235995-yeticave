        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= htmlspecialchars($val['lots_title']); ?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount"><?= htmlspecialchars($val['starting_price']); ?></span>
                            <span class="lot__cost"><?= format_price(htmlspecialchars($val['starting_price'])) ?><!-- <b class="rub">р</b> --></span>
                        </div>
