    ...
    <form class="form form--add-lot container <?php if(isset($errors)): ?>form--invalid<?php endif;?>" action="add-lot.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__item form__item--file  <?php if(isset($errors['img-file'])): ?>form__item--invalid<?php endif;?>"> <!-- form__item--uploaded -->
      ...
      <div class="form__container-three <?php if(isset($errors)): ?>form--invalid<?php endif;?>">
